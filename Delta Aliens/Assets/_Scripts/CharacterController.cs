...
public class CharacterController : MonoBehaviour
{
    ...
    [Range(0, 1)] [SerializeField] private float m_CrouchSpeed = .66f;			// Amount of maxSpeed applied to crouching movement. 1 = 100%
    ...
    private Vector2 m_TargetJumpVelocity = Vector2.zero;
    ...
    public void Move(float move, bool crouch, bool jump)
    {
        ...
        if (m_Grounded || m_AirControl)
        {
            ...
            if (!m_Grounded) {
                targetVelocity = new Vector2(move * 3f, m_Rigidbody2D.velocity.y) + m_TargetJumpVelocity;
            } else {
